...
The base branch is the cohort branch, not `main`. Check it before you submit, because the default is usually wrong.
...
- Anything you copied from the `reference` branch rather than working out, and why.
